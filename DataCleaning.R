...
train_clean$ps_car_03_cat <- as.factor(train_clean$ps_car_03_cat)
train_clean$ps_car_04_cat <- as.factor(train_clean$ps_car_04_cat)
train_clean$ps_car_05_cat <- as.factor(train_clean$ps_car_05_cat)
...
test_clean$ps_car_03_cat <- as.factor(test_clean$ps_car_03_cat)
test_clean$ps_car_04_cat <- as.factor(test_clean$ps_car_04_cat)
test_clean$ps_car_05_cat <- as.factor(test_clean$ps_car_05_cat)
